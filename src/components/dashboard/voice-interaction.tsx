...
const commands: Command[] = [
  {
    id: 'c1',
    time: '14:32:08',
    transcript: 'Turn on the living room lights at 60% brightness',
  ...
  },
  {
    id: 'c2',
    time: '14:28:51',
    transcript: 'Set an alarm for 7 AM tomorrow',
  ...
  },
  {
    id: 'c3',
    time: '14:21:34',
    transcript: 'Play my focus playlist on the bedroom speaker',
    device: 'Bedroom Hub',
    confidence: 0.92,
    status: 'success',
    intent: 'media.play',
  },
  {
    id: 'c4',
    time: '14:14:02',
    transcript: 'What is the weather forecast for the weekend',
  ...
  },
  {
    id: 'c5',
    time: '14:08:47',
    transcript: 'Call mum on speakerphone',
    device: "Ola's iPhone 15 Pro",
    confidence: 0.95,
    status: 'success',
    intent: 'call.initiate',
  },
  {
    id: 'c6',
    time: '13:59:22',
    transcript: 'Remind me to take out the trash at 6',
  ...
  },
  {
    id: 'c7',
    time: '13:51:09',
    transcript: 'Decrease the thermostat by two degrees',
    device: 'Living Room Speaker',
    confidence: 0.94,
    status: 'success',
    intent: 'climate.adjust',
  },
]
...
function Waveform() {
  ...
  useEffect(() => {
    const id = setInterval(() => {
      setBars((prev) =>
        prev.map((_, i) => {
          // Generate smooth, speech-like pattern
  ...
  return (
    <div
      className="flex items-center justify-center gap-[2px] h-20"
      role="img"
      aria-label="Live voice waveform — listening"
    >
      {bars.map((h, i) => (
        <div
          key={i}
  ...
  return (
    ...
    >
      <header className="flex items-center justify-between gap-3 p-4 border-b border-border">
        <div>
            ...
            >
              <span
                className={cn(
                  ...
                  listening ? 'bg-emerald-500 live-dot' : 'bg-muted-foreground'
                )}
                aria-hidden="true"
              />
          ...
          <p className="text-[11px] text-muted-foreground mt-0.5">
            Wake word “Aria” active · {todayCount} commands today
          </p>
        </div>
        <button
          type="button"
          ...
          className={cn(
            'inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-md border border-border text-xs transition-colors',
            listening
              ? 'hover:bg-muted'
              : 'bg-accent text-accent-foreground border-accent hover:bg-accent/90'
          )}
          aria-pressed={listening}
          aria-label={listening ? 'Pause voice listening' : 'Resume voice listening'}
        >
          {listening ? (
        ...
        <div className="bg-card p-4 md:col-span-2 flex flex-col">
          ...
          {listening ? (
            ...
            <div className="h-20 flex items-center justify-center text-xs text-muted-foreground">
              Microphone muted — click Resume to continue
            </div>
          )}
          <div className="mt-2 text-[11px] text-muted-foreground font-mono">
            16 kHz · 1-channel · VAD active
          </div>
        </div>
      ...
      <div className="border-t border-border">
        ...
        <ul
          className="divide-y divide-border max-h-[320px] overflow-y-auto"
          role="log"
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-1 flex flex-wrap items-center gap-x-2 gap-y-1 text-[11px] text-muted-foreground">
                      <span className="font-mono">{c.device}</span>
